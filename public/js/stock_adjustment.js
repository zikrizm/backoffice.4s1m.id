...
function stock_adjustment_product_row(variation_id) {
    ...
    $.ajax({
        ...
        data: { row_index: row_index, variation_id: variation_id, location_id: 
location_id },
        dataType: 'html',
        success: function (result) {
...
function update_table_total() {
    ...
    $('table#stock_adjustment_product_table tbody tr').each(function () {
        var this_total = 
parseFloat(__read_number($(this).find('input.product_line_total')));
        if (this_total) {
...
function update_table_row(tr) {
    ...
    var unit_price = 
parseFloat(__read_number(tr.find('input.product_unit_price')));
    var row_total = 0;
