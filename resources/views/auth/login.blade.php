...
<div class="col-md-12 col-xs-12">
    ...
    <div class="col-md-6 col-xs-6"
        ...
        <img src="https://ph-test-11.slatic.net/shop/7184c88c77a3d6ff9fce097a8ec4debe.jpeg" style="width: 100%" alt=""
            srcset="">
    </div>
    <div class="col-md-3 col-xs-3" style="text-align: left;"></div>
</div>
        ...
        <form method="POST" action="{{ route('login') }}" id="login-form">
            ...
            <div class="form-group">
                <button type="submit" style="width: 100%;"
                    class="btn btn-danger btn-flat btn-login">@lang('lang_v1.login')</button>
                {{-- @if(config('app.env') != 'demo')
