...
<div class="row" style="font-size: 12px;font-family:'Calibri, sans-serif';">
	<!-- Logo -->
	...
	<div class="col-xs-12 text-center">
		...
		!empty($receipt_details->website)&& !empty($receipt_details->location_custom_fields))
		<p>
		...
		!empty($receipt_details->sub_heading_line3) && !empty($receipt_details->sub_heading_line4) &&
...
<div class="row" style="font-size: 12px;font-family:'Calibri, sans-serif';">
	<div class="col-xs-12">
		...
		@endphp
		@endif
		<table class="table table-responsive table-slim" style="border-bottom: black;margin-bottom:5px" border="1">
			<thead>
				<tr>
					<th style="border-bottom:1px solid black" width="2%">No</th>
					<th style="border-bottom:1px solid black" width="{{$p_width}}%">
						{{$receipt_details->table_product_label}}
					</th>
					<th style="border-bottom:1px solid black" class="text-right" width="15%">
			...
			<tbody>
				...
				@endphp
				<tr>
					<td style="border-top: black" class="text-center">{{$nomor}}</td>
					...
					<td style="border-top: black" class="text-right">{{$line['quantity_uf']}} {{$line['units']}} </td>
					<td style="border-top: black" class="text-right">{{$line['unit_price_before_discount']}}</td>
					@if(!empty($receipt_details->item_discount_label))
					<td style="border-top: black" class="text-right">
						{{$line['line_discount'] ?? '0.00'}}
					</td>
					@endif
					<td style="border-top: black" class="text-right">{{$line['line_total']}}</td>
				</tr>
				...
				<tr>
					...
					<td style="border-top: black" class="text-right">{{$modifier['quantity']}} {{$modifier['units']}}
					</td>
					<td style="border-top: black" class="text-right">{{$modifier['unit_price_inc_tax']}}</td>
					@if(!empty($receipt_details->item_discount_label))
					<td style="border-top: black" class="text-right">0.00</td>
					@endif
					<td style="border-top: black" class="text-right">{{$modifier['line_total']}}</td>
				</tr>
				@endforeach
				@endif
				@empty
				<tr>
					<td style="border-top: black" colspan="4">&nbsp;</td>
				</tr>
				@endforelse
				@for ($i = 0; $i < 9 - count($receipt_details->lines); $i++)
					<tr>
						<td style="border-top: black" class="text-center">{{$nomor + ($i+1)}}</td>
						<td style="border-top: black;color:white;">
